...
The measured results show a very clear shift in cost as the number of particles increases. For the $N=200$ profiling run, the total runtime was about $0.062$~s, with about $0.0473$~s already spent in particle-contact work alone. For the $N=1000$ case, the total runtime rose to about $1.073$~s, of which about $1.0504$~s came from the particle-contact stage. By the time the system reaches $N=5000$, the full run takes about $35.078$~s and about $35.0081$~s of that time is spent in particle-contact handling. In other words, once the particle count becomes moderate or large, almost the entire runtime is consumed by contact evaluation.
...
\begin{table}[t]
    ...
    \begin{tabular}{rrrrrrr}
        ...
        \hline
        200 & 0.062 & 0.0003 & 0.0473 & 0.0005 & 0.0003 & 0.0128 \\
        1000 & 1.073 & 0.0015 & 1.0504 & 0.0022 & 0.0017 & 0.0161 \\
        5000 & 35.078 & 0.0095 & 35.0081 & 0.0145 & 0.0114 & 0.0338 \\
        \hline
    \end{tabular}%
    }
\end{table}
